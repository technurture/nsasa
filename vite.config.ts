...
export default defineConfig({
  ...
  define: {
    ...
    'import.meta.env.VITE_CLOUDINARY_UPLOAD_PRESET': JSON.stringify(process.env.VITE_CLOUDINARY_UPLOAD_PRESET || process.env.CLOUDINARY_UPLOAD_PRESET || 'ml_default'),
  },
  resolve: {
    alias: {
